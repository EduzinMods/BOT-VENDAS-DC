...
client.once('ready', async () => {
  ...
  client.on("guildMemberAdd", async (member) => {
    ...
    let guild = client.guilds.cache.get("1143367931225452685");
    let channel = client.channels.cache.get("1143750213509578823");
    const cargo = member.guild.roles.cache.get("1143747922903707658")
    ...
    if (guild != member.guild) {
      ...
      .setTitle (`Bem vindo(a) ao SMITH STORE!`)
      .setDescription(`**<:ak:1144229187272585307> ${member.user.tag}\n\n<:suporte:1144229390859894784>  Para Adquirir ou saber mais sobre o nosso software abra um ticket  \n\nAtualmente estamos com ${guild.memberCount} usuários.**`)
        ...
        if (eprod) {
            ...
            const row = new Discord.MessageActionRow()
                .addComponents(
                    new Discord.MessageButton()
                        ...
                        .setLabel('Comprar')
                        .setEmoji("<:pixblack:1144140931491176490>")
                        .setStyle(config.botao),
                );
            const embed = new Discord.MessageEmbed()
                .setTitle(`${config.nomebot} | Produto`)
                .setDescription(`\`\`\`${db.get(`${interaction.customId}.desc`)}\`\`\`\n<:CARRINHODECOMPRAS:1143913153399377930> - **Nome:** **__${db.get(`${interaction.customId}.nome`)}__**\n<:money:1144215922555506689> - **Preço:** **__R$${db.get(`${interaction.customId}.preco`)}__**\n<:cxb:1144137963710709780> - **Estoque:** **__${db.get(`${interaction.customId}.conta`).length}__**`)
                .setColor(config.cor)
            ...
            interaction.guild.channels.create(`carrinho-${interaction.user.username}`, {
               ...
               //)
                ...
                .setDescription(`Selecione o metodo de pagamento:\n\n<:pixblack:1144140931491176490>** - PIX**\n<:xx:1144181794917326859>** - PARA CANCELAR A COMPRA**`)
                .setColor(config.cor)
                ...
                collector.on("collect", interaction2 => {
                        ...
                        if (interaction2.customId == 'pix') {
                            ...
                            const embedss = new Discord.MessageEmbed()
                                ...
                                .setDescription(`<:cxb:1144137963710709780> **Produto: **\`${eprod.nome}\`\n<:CARRINHODECOMPRAS:1143913153399377930> **Quantidade: **\`${quantidade1}\`\n\n<:money:1144215922555506689> **Preço: **\`R$${precoalt}\``)
                                .setColor(config.cor)
...
msg.channel.bulkDelete(50);
                                        ...
                                        mercadopago.payment.create(payment_data).then(function (data) {
                                            ...
                                            const embed = new Discord.MessageEmbed()
                                                ...
                                                .setDescription(`<:pixblack:1144140931491176490> - Efetue o pagamento de \`${eprod.nome}\` escaneando o QR Code abaixo.\n\n> Caso prefira efetuar o pagamento copiando e colando o código em seu aplicativo do banco, clique no botão “<:qrcode:1144140117120913428>”, o bot irá enviar nesse chat o código do seu pagamento.`)
                ...
                if (interaction.customId === "descgerenciar") {
                    ...
                    interaction.channel.send({ embeds: [embeddesc] }).then(msg => {
                        ...
                        collector.on("collect", message => {
                            ...
                            const embed = new Discord.MessageEmbed()
                                .setDescription(`Olá, para você gerenciar um produto\nselecione o menu abaixo e clique no produto que você quer gerenciar!`)
                                .setColor(config.cor)
                            msg.edit({ embeds: [embed], components: [row] })
                        })
                    })
